...
<template>
    <div class="progress-circle">
        <svg :width="size" :height="size" class="circular-progress" :aria-label="`${label} skill at ${progress}%`">
            <defs>
        ...
        <div class="progress-label">
            <svg v-if="iconName === 'typescript'" aria-hidden width="24px" height="24px" viewBox="0 0 24 24" role="img"
            ...
            <ion-icon v-else :name="iconName" aria-hidden></ion-icon>
        </div>
    </div>
</template>
